...
mydb=mysql.connector.connect(host="localhost", user="root", password="A1b2c3$2011", database="pytest")
con=mydb.cursor()
for i in range(35):
  query = "INSERT INTO Testuser (userID, Name, Speciality, PhoneNumber, FullAddress, Street, City, State, Zip, Url) VALUES({},'{}','{}','{}','{}','{}','{}','{}','{}','{}')".format(i,names[i],specl[i],phnum[i],fulladd[i],stradd[i],city[i],state[i],Zip[i],Url[i])
  con.execute(query)
